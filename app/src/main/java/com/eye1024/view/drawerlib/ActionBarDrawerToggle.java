package com.eye1024.view.drawerlib;
...
//            }
            ...
            final TextView home = (TextView) mActivity.getActionBar().getCustomView().findViewById(android.R.id.home);
            if (home == null) {
                return;
            }
            home.setCompoundDrawablesWithIntrinsicBounds(mDrawerImage,null,null,null);
