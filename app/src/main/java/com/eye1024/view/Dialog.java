...
public class Dialog extends android.app.Dialog{
    ...
    public Dialog applyStyle(int resId){
        ...
        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_android_layout_width) == TypedValue.TYPE_DIMENSION)
            layout_width = a.getDimensionPixelSize(com.rey.material.R.styleable.Dialog_android_layout_width, 0);
        else
            layout_width = a.getInteger(com.rey.material.R.styleable.Dialog_android_layout_width, ViewGroup.LayoutParams.WRAP_CONTENT);

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_android_layout_height) == TypedValue.TYPE_DIMENSION)
            layout_height = a.getDimensionPixelSize(com.rey.material.R.styleable.Dialog_android_layout_height, 0);
        else
            layout_height = a.getInteger(com.rey.material.R.styleable.Dialog_android_layout_height, ViewGroup.LayoutParams.WRAP_CONTENT);

        layoutParams(layout_width, layout_height);

        dimAmount(a.getFloat(com.rey.material.R.styleable.Dialog_di_dimAmount, 0.5f));
        backgroundColor(a.getColor(com.rey.material.R.styleable.Dialog_di_backgroundColor, ThemeUtil.windowBackground(context, 0xFFFFFFFF)));
        maxElevation(a.getDimensionPixelOffset(com.rey.material.R.styleable.Dialog_di_maxElevation, 0));
        elevation(a.getDimensionPixelOffset(com.rey.material.R.styleable.Dialog_di_elevation, ThemeUtil.dpToPx(context, 4)));
        cornerRadius(a.getDimensionPixelOffset(com.rey.material.R.styleable.Dialog_di_cornerRadius, ThemeUtil.dpToPx(context, 2)));
        layoutDirection(a.getInteger(com.rey.material.R.styleable.Dialog_di_layoutDirection, View.LAYOUT_DIRECTION_LOCALE));

        titleTextAppearance(a.getResourceId(com.rey.material.R.styleable.Dialog_di_titleTextAppearance, com.rey.material.R.style.TextAppearance_AppCompat_Title));
        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_titleTextColor) != TypedValue.TYPE_NULL)
            titleColor(a.getColor(com.rey.material.R.styleable.Dialog_di_titleTextColor, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_actionBackground) != TypedValue.TYPE_NULL)
            actionBackground(a.getResourceId(com.rey.material.R.styleable.Dialog_di_actionBackground, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_actionRipple) != TypedValue.TYPE_NULL)
            actionRipple(a.getResourceId(com.rey.material.R.styleable.Dialog_di_actionRipple, 0));

        actionTextAppearance(a.getResourceId(com.rey.material.R.styleable.Dialog_di_actionTextAppearance, com.rey.material.R.style.TextAppearance_AppCompat_Button));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_actionTextColor) != TypedValue.TYPE_NULL)
            actionTextColor(a.getColorStateList(com.rey.material.R.styleable.Dialog_di_actionTextColor));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_positiveActionBackground) != TypedValue.TYPE_NULL)
            positiveActionBackground(a.getResourceId(com.rey.material.R.styleable.Dialog_di_positiveActionBackground, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_positiveActionRipple) != TypedValue.TYPE_NULL)
            positiveActionRipple(a.getResourceId(com.rey.material.R.styleable.Dialog_di_positiveActionRipple, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_positiveActionTextAppearance) != TypedValue.TYPE_NULL)
            positiveActionTextAppearance(a.getResourceId(com.rey.material.R.styleable.Dialog_di_positiveActionTextAppearance, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_positiveActionTextColor) != TypedValue.TYPE_NULL)
            positiveActionTextColor(a.getColorStateList(com.rey.material.R.styleable.Dialog_di_positiveActionTextColor));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_negativeActionBackground) != TypedValue.TYPE_NULL)
            negativeActionBackground(a.getResourceId(com.rey.material.R.styleable.Dialog_di_negativeActionBackground, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_negativeActionRipple) != TypedValue.TYPE_NULL)
            negativeActionRipple(a.getResourceId(com.rey.material.R.styleable.Dialog_di_negativeActionRipple, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_negativeActionTextAppearance) != TypedValue.TYPE_NULL)
            negativeActionTextAppearance(a.getResourceId(com.rey.material.R.styleable.Dialog_di_negativeActionTextAppearance, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_negativeActionTextColor) != TypedValue.TYPE_NULL)
            negativeActionTextColor(a.getColorStateList(com.rey.material.R.styleable.Dialog_di_negativeActionTextColor));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_neutralActionBackground) != TypedValue.TYPE_NULL)
            neutralActionBackground(a.getResourceId(com.rey.material.R.styleable.Dialog_di_neutralActionBackground, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_neutralActionRipple) != TypedValue.TYPE_NULL)
            neutralActionRipple(a.getResourceId(com.rey.material.R.styleable.Dialog_di_neutralActionRipple, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_neutralActionTextAppearance) != TypedValue.TYPE_NULL)
            neutralActionTextAppearance(a.getResourceId(com.rey.material.R.styleable.Dialog_di_neutralActionTextAppearance, 0));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.Dialog_di_neutralActionTextColor) != TypedValue.TYPE_NULL)
            neutralActionTextColor(a.getColorStateList(com.rey.material.R.styleable.Dialog_di_neutralActionTextColor));

        inAnimation(a.getResourceId(com.rey.material.R.styleable.Dialog_di_inAnimation, 0));
        outAnimation(a.getResourceId(com.rey.material.R.styleable.Dialog_di_outAnimation, 0));
        dividerColor(a.getColor(com.rey.material.R.styleable.Dialog_di_dividerColor, 0x1E000000));
        dividerHeight(a.getDimensionPixelOffset(com.rey.material.R.styleable.Dialog_di_dividerHeight, ThemeUtil.dpToPx(context, 1)));
        setCancelable(a.getBoolean(com.rey.material.R.styleable.Dialog_di_cancelable, true));
        setCanceledOnTouchOutside(a.getBoolean(com.rey.material.R.styleable.Dialog_di_canceledOnTouchOutside, true));
