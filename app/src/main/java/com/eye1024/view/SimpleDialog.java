...
public class SimpleDialog extends Dialog {
    ...
    public SimpleDialog(Context context) {
        super(context, com.rey.material.R.style.Material_App_Dialog_Simple_Light);
    }
    ...
    public Dialog applyStyle(int resId) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(resId, com.rey.material.R.styleable.SimpleDialog);

        messageTextAppearance(a.getResourceId(com.rey.material.R.styleable.SimpleDialog_di_messageTextAppearance, com.rey.material.R.style.TextAppearance_AppCompat_Body1));

        if(ThemeUtil.getType(a, com.rey.material.R.styleable.SimpleDialog_di_messageTextColor) != TypedValue.TYPE_NULL)
            messageTextColor(a.getColor(com.rey.material.R.styleable.SimpleDialog_di_messageTextColor, 0));

        radioButtonStyle(a.getResourceId(com.rey.material.R.styleable.SimpleDialog_di_radioButtonStyle, 0));
        checkBoxStyle(a.getResourceId(com.rey.material.R.styleable.SimpleDialog_di_checkBoxStyle, 0));
        itemHeight(a.getDimensionPixelSize(com.rey.material.R.styleable.SimpleDialog_di_itemHeight, ViewGroup.LayoutParams.WRAP_CONTENT));
        itemTextAppearance(a.getResourceId(com.rey.material.R.styleable.SimpleDialog_di_itemTextAppearance, com.rey.material.R.style.TextAppearance_AppCompat_Body1));
    ...
    public static class Builder extends Dialog.Builder implements OnSelectionChangedListener {
        ...
        public Builder(){
            super(com.rey.material.R.style.Material_App_Dialog_Simple_Light);
        }
